...
const date=new Date();
const ageinfo=date.getFullYear()-1996;
const About = () => (
        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Alex Leonardo Christancho Molina and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    <div>
                    <img alt="Blender" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/blender/blender-original.svg" />
                        <h5>Blender</h5>
                    </div>
                    <div>
                    <img alt="Typescript" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/threejs/threejs-original.svg" />
                        <h5>ThreeJS</h5>
                    </div>
                    <div>
