        ...
        <section className="sobre-mi-seccion" id="sobre-mi">
          ...
          <div className="skill-seccion">
            ...
            <div className="skill-container">
              ...
              <div className="skill-card" data-aos="flip-left" data-aos-delay="300">
                <img alt="ThreeJS" className="skills-img icon-li" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/threejs/threejs-original.svg" title="ThreeJS" />
                <h2 className="skill-name">ThreeJS</h2>
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-4'
              ...
              <div className="skill-card" data-aos="flip-down" data-aos-delay="300">
                <img alt="Git" className="skills-img" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/git/git-original.svg" title="Git" />
                <h2 className="skill-name">Git</h2>
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-5'
                    defaultMessage='Git is a distributed version control system that allows multiple developers to track and manage changes to source code collaboratively.'
                  />
                </p>
              </div>
              <div className="skill-card" data-aos="flip-right" data-aos-delay="300">
                <img alt="Blender" className="skills-img" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/blender/blender-original.svg" title="Blender" />
                <h2 className="skill-name">Blender</h2>
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-6'
                    defaultMessage='Blender is a free and open-source 3D creation software that can be used for 3D modeling, rigging, animation, rendering, and video editing, allowing users to create 3D models, animations, and visual effects for various industries such as film, television, and video games.'
                  />
                </p>
              </div>
              <div className="skill-card" data-aos="flip-right" data-aos-delay="300">
              ...
              <div className="skill-card" data-aos="flip-left" data-aos-delay="300">
                <img alt="typescript" className="skills-img" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg" title="jQuery" />
                <h2 className="skill-name">Typescript</h2>
                <p className="skill-info">
                  <FormattedMessage
                    id='about-skills-9'
                    defaultMessage='TypeScript is a statically typed superset of JavaScript that adds optional type annotations and other features to enhance development and improve code quality.'
                  />
                </p>
              </div>
            </div>
